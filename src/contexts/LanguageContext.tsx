...
const translations: Translations = {
  ...
  premiumDesc: {
    tr: '50 Site Oluşturma ve 500 Güncelleme kredisi kazanın. Her işlem için 10 kredi düşülür.',
    'en-us': 'Get 50 Site Creation and 500 Update credits. 10 credits are deducted for each action.',
    'en-uk': 'Get 50 Site Creation and 500 Update credits. 10 credits are deducted for each action.',
  },
  featureUnlimitedSites: {
    tr: '50 Site Oluşturma Kredisi',
    'en-us': '50 Site Creation Credits',
    'en-uk': '50 Site Creation Credits',
  },
  featureUnlimitedUpdates: {
    tr: '500 Güncelleme Kredisi',
    'en-us': '500 Update Credits',
    'en-uk': '500 Update Credits',
  },
  featurePublishing: {
    tr: 'Her işlem 10 kredi maliyetindedir',
    'en-us': 'Each action costs 10 credits',
    'en-uk': 'Each action costs 10 credits',
  },
